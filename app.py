...
<html dir="rtl" lang="ar">
<head>
  <title>منصة تسليم المشاريع</title>
  """ + BASE_STYLE + """
  <style>
    ...
    h2 { font-size: 22px; color: #1a73e8; margin-bottom: 8px; }
    p.sub { color: #777; font-size: 14px; margin-bottom: 32px; }
    .btn-big { display: block; padding: 16px; border-radius: 10px;
               font-size: 16px; text-decoration: none; margin-bottom: 14px;
               font-weight: bold; transition: opacity .2s; }
    .btn-big:hover { opacity: .85; }
    .btn-student { background: #1a73e8; color: white; }
    .btn-doctor  { background: #f8f9fa; color: #333;
...
<div class="card">
  <div class="logo">🎓</div>
  <h2>منصة تسليم المشاريع</h2>
  <p class="sub">اختر نوع دخولك للمتابعة</p>

  <a href="#student-section" class="btn-big btn-student"
     onclick="document.getElementById('student-section').scrollIntoView()">
    📤 أنا طالب — أريد تسليم مشروعي
  </a>

  <a href="/admin/login" class="btn-big btn-doctor">
    🔐 أنا دكتور — دخول لوحة التحكم
  </a>

  <p class="note">
    إذا كنت طالباً، استخدم الرابط الخاص الذي أرسله لك دكتورك
  </p>
</div>
</body>
</html>
